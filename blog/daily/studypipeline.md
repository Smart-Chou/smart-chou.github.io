...
比如笔记中的截图，我是使用一个oss的上传插件，将图片上传到云服务的oss存储，没有去折腾一些免费的方案，因为资料对我而言是非常有价值的，截图工具我使用的是[snipaste](/tools/creat/snipaste.md)，很方便的做些简单的编辑，如果需要制作GiF动态图，我会使用[ScreenToGif](/tools/creat/screentogif.md)
...
首先我的桌面图标不是很多，我使用[utools](/tools/creat/utools.md)这个工具来启动应用；然后搜索文件、搜索开发文档基本也是使用这个工具
...
平时我使用[mobaXterm](/tools/creat/mobaXterm.md)来连接虚拟机，开一个本地命令行的窗口，然后开三个虚拟机的窗口，整个使用起来就非常的简洁，并且还支持文件传输，ftp工具也省了

![#](https://cdn.jsdelivr.net/gh/Smart-Chou/webphoto/image/164710-81750.png)

## 自媒体

关于制作视频我是非常简陋的，使用pr来剪辑，需要上字幕的视频我都是自己手动使用 arctime 打轴的，偶尔用一用自动生成的，这里我要吐槽一下川普的识别率不高啊！
